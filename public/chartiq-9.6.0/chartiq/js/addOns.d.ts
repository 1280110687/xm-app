...
declare module '../js/chartiq.js' {
  ...
  export namespace CIQ {
    ...
    class DataLoader {
       ...
       * @param dataObj CIQ.CSVReader which contains the parsed data
       * @param dataOptions FormData options that get the name of the imported data
       */
      public formatData(dataObj: CIQ.CSVReader, dataOptions: FormData): void
      /**
       * Imports data from a CIQ.CSVReader and loads it into the chart based on FormData parameters.
       * @param dataObj CIQ.CSVReader that contains parsed data
       */
      public importData(dataObj: CIQ.CSVReader): void
    }
    /**
    ...
    class CSVReader {
      /**
       * Helper class to read loaded web files with a FileReader.
       * @param file Web file that the CSVReader should parse.
       * @since 8.4.0
       */
       ...
       * @param file File to passed to the FileReader and parsed.
       * @async
       * @return
       */
       ...
       * @param data Raw parsed values from the FileReader
       * @return string Identified line break in the file which will be used to split results
       */
      public determineLineBreak(data: string): void
      /**
       * Splits data from the FileReader based on determined linebreak.
       * @param data Parsed data from FileReader
       * @return string[] Split data from the FileReader
       */
      public splitResults(data: string): void
    }
    /**
     ...
     * [cq-floating-window]WebComponents.FloatingWindow web component by dispatching a
     ...
     * tutorial).
     *
     *  The keyboard shortcuts legend can be toggled using the Shift+Alt+? keystroke combination (see the
    ...
    class Shortcuts {
       ...
       * @param [node] Optional node which triggered the toggle.
       *
       * @since 8.2.0
       * @since 9.1.0 Added `node` parameter.
       */
      public toggle(value?: boolean, node?: HTMLElement): void
    }
    /**
    ...
    class TableView {
       ...
       * @param [params.builderConfig] Optional object to configure the TableViewBuilder's static properties.
       *
       * @since
       * - 8.1.0
       * - 9.1.0 Added `builderConfig` parameter.
       ...
       * @since 8.7.0
       */
      public setup(config: object): void
      /**
       ...
       * 		closed.
       * @param [params.processCloseEvent] A function to receive event that closes table. If required,
       ...
       * @return Channel name subscribed to.
       *
       * @since
       * - 8.1.0
       * - 9.1.0 Returns the channel name.
       */
      public subscribeToChanges(uiContext: CIQ.UI.Context, channelPath?: string): string
    }
    /**
    ...
    class Tooltip {
       ...
       * @param [tooltipParams.ohl] Setting for OHL data (Close is always shown).
       * @param [tooltipParams.volume] Setting for Volume.
       ...
       * @param [tooltipParams.signalStudies] Set to true to show value of signalling studies
       * 		even when they are hidden.
       ...
       * 		is ignored.
       * @param [tooltipParams.caption] Set to caption text for assistive technologies
       *
       * @since
       * - 09-2016-19
       * - 5.0.0 Now `tooltipParams.showOverBarOnly` is available to show tooltip only when over the
    ...
    class Animation {
       ...
       * @param config.easeMachine Override the default easeMachine.  Default is `new CIQ.EaseMachine("easeOutCubic", 1000);`
       * @since
       * - 3.0.0 Now part of *addOns.js*. Previously provided as a standalone *animation.js* file.
       * - 4.0.0 Beacon only flashes for line charts. On candles or bars, it is suppressed as it produces an unnatural effect.
       * - 7.0.2 Now takes one configuration object as its constructor. Must have a reference to a chart engine.
  ...
  export namespace TableViewBuilder {
     ...
     * @return toolbar Constructed toolbar container element.
     * @since
     * - 8.7.0
     */
    function createToolbar(stx: CIQ.ChartEngine, config?: {fileNameFormatter?: Function}): HTMLElement
    /**
     * Creates column header object
     *
     * @param stx  A reference to the chart engine that contains the chart for
     * 		which the column headers object is created.
     * @return Colum header object
     * @since 9.3.0
     */
    function getColumnHeaders(stx: CIQ.ChartEngine): void
    /**
     ...
     */
    function downloadCsv(csvString: string, filename: string, stx?: CIQ.ChartEngine): void
    /**
     ...
     * @param params.stx Chart engine instance.
...
export function dataLoader(_export: object): void
export function extendedHours(_export: object): void
export function fullScreen(_export: object): void
export function inactivityTimer(_export: object): void
export function rangeSlider(_export: object): void
export function shortcuts(_export: object): void
export function tableView(_export: object): void
export function tooltip(_export: object): void
export function animation(_export: object): void
export function continuousZoom(_export: object): void
export function outliers(_export: object): void
export function plotComplementer(_export: object): void