 ...
 *
 * @param {object[]} data Array of objects representing the data to use when generating the SVG graphic.
 ...
 * @param {function|string[]} [attributes.colorRange] Optional function or array for setting the range of colors. The function should return an array.
