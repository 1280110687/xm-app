...
if (CIQ.UI) {
	/**
	 * Overwrites CIQ.UI.StudyEdit in componentUI.js, allowing for editing study for signaliq purposes.
	 *
	 * @param {object} params
	 * @param {boolean} editStudy
	...
	class SignalIQDialog extends CIQ.UI.DialogContentTag {
		constructor() {
			 ...
			 *
			 * @type {null|CIQ.Studies.StudyDescriptor}
			 * @tsmember WebComponents.SignalIQDialog
			 * @alias activeStudy
			 * @instance
			 */
		 ...
		 * @param {string[]|string[][]} fields A one-dimensional array of values or a two-dimensional array of name/value pairs.
		 ...
		 *
		 * @param {object[]} condition Array of parameters representing a condition on which the signal will trigger.
