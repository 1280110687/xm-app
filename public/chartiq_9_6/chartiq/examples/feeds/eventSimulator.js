 ...
 * @texport default eventFeed;
 */
/**
 * @typedef EventType
 * @property {Date} DT Record date
 * @property {EventDataType} data Example of a data record
 */
/**
 * @typedef EventDataType
 * @property {string} id Unique ID
 * @property {Date | null} group If a series of events are linked, name of linkage
 * @property {number} sequence If a series of events are linked, number in group sequence
 * @property {boolean} final True if last event in group
 * @property {Date} timestamp Time event happened
 * @property {string} category Type of event
 * @property {string} headline Title of event
 * @property {string | null} story Details of event
 * @property {string} source Source of event
 * @property {null | number} value Amount of event in currency
 * @property {null | number} size If trade, size in units
 * @property {null | string} url If news, url to story
 * @property {null | string} image If news, thumbnail image
 */
/**
 * @name eventFeed
 * @namespace
 ...
 * @param {Date} response.DT Date
 * @param {EventDataType} response.data Record containing event data
 * @param {string} eventId Unique ID
 * @return {EventType[]} Event records
 *
 * @memberof eventFeed
 */
