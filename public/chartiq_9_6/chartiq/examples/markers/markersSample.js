...
/**
 *
 * @module ./markersSample
 * @timport { CIQ } from '../../js/standard.js';
 * @texport declare let marker: { MarkersSample: MarkersSample }
 * @texport default marker
 */
 ...
 * @param {string} methodName Name of handler
 * @param {boolean} overwrite Force overwrite of any existing handler of that name
 *
 * @memberof MarkersSample#
 */
 ...
 *
 * @param {string[]} labels Name of new label to show
 * @return {string[]} Name of new label to show
 *
 * @memberof MarkersSample#
 */
 ...
 *
 * @param {string} label Label of marker to create
 * @param {string} markerType Class name of marker
 * @return {string}
 *
 * @memberof MarkersSample#
 */
 ...
 *
 * @param {string} abstractType Type name of marker
 * @return {string} Type name of marker
 *
 * @memberof MarkersSample#
 */
 ...
 *
 * @param {string} type Marker label name to hide
 *
 * @memberof MarkersSample#
 */
 ...
 *
 * @param {string} type Marker label to show
 * @param {string} renderType Class name of marker
 *
 * @memberof MarkersSample#
 */
