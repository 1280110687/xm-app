...
declare module '../js/chartiq.js' {
  ...
  export namespace CIQ.UI {
    ...
    class Context {
       ...
       * [cq-lookup]WebComponents.Lookup web component.
       *
       ...
       * @param  helperName The type of UI Helper to look for
       * @return The associated helper
       */
      public getAdvertised(helperName: string): CIQ.UI.Helper|undefined
      /**
       ...
       *
       * @return true if a [cq-study-legend]WebComponents.StudyLegend component is
    ...
    class Helper {
       ...
       * @param params.node Node that owns the observer
       ...
       *
       * @param node Node that owns the observer(s)
       *
       * @since 8.8.0
       */
      public removeObservers(node: HTMLElement): void
      /**
     ...
     * - default - The heads up will be a marker within the chart, positioned in the chart panel unless overridden
     *
     * @since
     * - 3.0.0
    ...
    class DrawingEdit {
       ...
       *
       * @param drawing The drawing to use if the drawingContext UI is bypassed.
       * @since
       * - 7.0.0
       * - 8.6.0 Allow a drawing object to be passed into the function.
       */
      public text(drawing: CIQ.Drawing): void
      /**
     ...
     * {@tutorial Web Component Interface}.
     *
     * Requires the [cq-study-dialog]WebComponents.StudyDialog web component.
     *
    ...
    class StudyEdit {
       ...
       */
      public remove(activator: {params: {parent: HTMLElement}}): void
      /**
       ...
       * @param activator.params.parent Parent node of activator
       */
      public edit(activator: {params: {parent: HTMLElement}}): void
      /**
       * Finds the [cq-study-dialog]WebComponents.StudyDialog web component and proxies
    ...
    class Layout {
       ...
       *
       * @param node The user interface element that needs to be checked/unchecked.
       * @param [state] Whether element is to be checked.
       *
       * @since 8.8.0
       */
      public setCheckedState(node: HTMLElement, state?: boolean): void
      /**
       ...
       *
       * @param obj An object containing the user interface element,
       ...
       *
       */
      public setChartType(obj: CIQ.UI.Setter, chartType?: string): void
      /**
       ...
       *
       * @param obj Either null or an object containing the user interface element,
       *		trigger event, and additional param object.
       * @param chartScale The type of scaling, such as "log", "linear", "percent", or
       * 		"relative".
       *
       */
      public setChartScale(obj: CIQ.UI.Setter|null, chartScale: String): void
      /**
       ...
       * @since 6.3.0
       */
      public setFlippedChart(obj: CIQ.UI.Setter|null): void
      /**
       ...
       *
       */
      public setExtendedHours(obj: CIQ.UI.Setter|null): void
      /**
       ...
       * @since 8.4.0
       */
      public setAnimation(obj: CIQ.UI.Setter|null): void
      /**
       ...
       *
       */
      public setRangeSlider(obj: CIQ.UI.Setter|null): void
      /**
       ...
       * @since 7.5.0
       */
      public setOutliers(obj: CIQ.UI.Setter|null): void
      /**
       * Activates the heads-up radio button on the drop-down menu.
       *
       * @param node The user interface element that allows users to select the
       * 		heads-up display type.
       * @param headsUpType Identifies the heads-up type.
       *
       * @since 8.9.0
       */
      public getHeadsUp(node: HTMLElement, headsUpType: String): void
      /**
       * Convenience function to set the heads-up type from the drop-down menu.
       *
       * @param [node] The user interface element that allows users to set the
       * 		heads-up type.
       * @param headsUpType The heads-up type to be set.
       *
       * @since 8.9.0
       */
      public setHeadsUp(node: HTMLElement | undefined, headsUpType: string): void
      /**
       ...
       *
       */
      public setAggregationType(obj: CIQ.UI.Setter|null, aggregationType: string): void
      /**
       ...
       */
      public setLanguage(obj: CIQ.UI.Setter): void
      /**
       ...
       * @param node The user interface element that enables users to select the chart
       * 		language.
       * @param position Position to insert the new chart relative to the existing chart(s). Available values are `before`and `after`.
       *
       * @since 8.6.0
       */
      public addChart(node: HTMLElement, position: string): void
      /**
       ...
       * @since 8.6.0
       */
      public removeChart(node: HTMLElement): void
      /**
       * Toggles display of cq-help components.
       *
       * @param node The user interface element that enables users to toggle the help.
       *
       * @since 8.4.0
       */
      public toggleHelp(node: HTMLElement): void
    }
    /**
    ...
    class Markers {
       ...
       *
       * @param activator
       * @param [activator.node] Element which activated this function.
    ...
    class Keystroke {
       ...
       * @param [params.node] Node to indicate the document to add keystroke to
       * @since 8.5.0 Added `node` parameter.
       */
      constructor(
        cb?: Function,
       ...
       *
       * @param key Key Code of command key
       * @return Internal representation of key
       */
     ...
     * configuration object and the availability of resources loaded in the CIQ namespace.
     *
     * @since 7.5.0
     */
    class Chart {
       ...
       * @return A callback that sets the active context of the keystroke hub.
       *
       * @since 7.5.0
       */
      ...
      /**
       * Creates and appends a [cq-color-picker]WebComponents.ColorPicker component
       * to the document body if one is not already attached.
       *
       * @param uiContext The chart user interface context.
       *
       * @deprecated The color picker is now context-based. See CIQ.UI.UIManager#getColorPicker.
       * @since
       * - 7.5.0
       * - 8.5.0 Added `uiContext` parameter.
       */
      public initColorPicker(uiContext: CIQ.UI.Context): void
      /**
       ...
       * @since 9.0.0
       */
      public initPluginChannelListeners(stx: CIQ.ChartEngine, uiContext: CIQ.UI.Context): void
      /**
       ...
       * @since 8.9.0
       */
      public initMenusAndToggles(uiContext: CIQ.UI.Context): void
      /**
       * Returns a setter function that updates the size of the side navigation panel by
       * positioning the chart container `div`.
       *
       * @param uiContext The chart user interface context.
       * @return A function that sets the size of the side navigation panel.
       *
       * @since 7.5.0
       */
       ...
       *
       * @param uiContext The chart user interface context.
       * @return A function that sets the top position of the chart area.
       *
       * @since 7.5.0
       ...
       * right margin of the plugin container
       *
       * @param uiContext The chart user interface context.
       * @return A function that sets the width of the side panel.
       *
       *
       * @since 7.5.0
       */
       ...
       *
       * @param uiContext The chart user interface context.
       * @return A function that sets the responsive break point of the UI context.
       *
       * @since 7.5.0
       */
       ...
       *
       * @param uiContext The chart user interface context.
       * @return A function that sets the class of the UI context.
       *
       * @since 8.8.0
       */
      public classSetter(uiContext: CIQ.UI.Context): Function
    }
    /**
    ...
    class Multichart {
       ...
       *
       * @param params
       * @param parms.container DOM node or query path identifyig the `cq-context` host element.
       * @param params.chartConfig Object containing parameters for chart creation in a multi-chart environment.
       * @param params.chartConfig.charts Array of objects containing the default symbol and `chartId` property.
       ...
       * @param [params.chartConfig.colCount] Maximum number of charts in a grid row.
       *	Adding a new chart past this value creates a new row.
       * @param config Chart configuration.
       * @return CIQ.ChartEngine[] Chart engine array.
       *
       * @since 8.6.0
       */
      public createCharts(
       ...
       *
       * @param container Multi-chart context container.
       * @param config Chart configuration object.
       * @param chartTemplate Chart markup template to create new charts.
       *
       * @since 8.6.0
       */
      public initContainer(container: HTMLElement, config: object, chartTemplate: string): void
      /**
       * Initializes a chart for a multi-chart environment.
       *
       * @param container Chart context container.
       * @param config Chart configuration object.
       * @param stx A reference to the chart engine.
       *
       * @since 8.6.0
       */
      public initChart(container: HTMLElement, config: object, stx: CIQ.ChartEngine): void
      /**
       * Creates and attaches the `addChart` method to the chart wrapper container.
       *
       * @param container Chart wrapper container.
       * @param config Chart configuration ojbject.
       * @param chartTemplate Chart template to create new charts.
       *
       * @since 8.6.0
       */
      public addChart(container: HTMLElement, config: object, chartTemplate: string): void
      /**
       ...
       * @since 8.8.0
       */
      public moveChart(container: HTMLElement, config: object): void
      /**
       ...
       * @since 8.6.0
       */
      public removeChart(container: HTMLElement, config: object): void
      /**
       ...
       * @since 8.6.0
       */
      public contextSwitcher(container: HTMLElement): void
      /**
       ...
       * @since 8.6.0
       */
      public solo(container: HTMLElement, config: object): void
      /**
       * Freezes chart drawing and resizing functions by setting them to no-op and returns function to restore them.
       *
       * @param stx A reference to the chart engine.
       * @return A function that can be called to unfreeze the engine.
       *
       * @since 8.8.4
       */
      public freezeEngineRendering(stx: CIQ.ChartEngine): Function
      /**
       * Transtion to solo mode.
       *
       * @param container Multi-chart container.
       * @param freezeEngineRenderingFunc `freezeEngineRendering` function to freeze chart rendering.
       *
       * @since 8.8.4
       */
      public transitionToSolo(container: HTMLElement, freezeEngineRenderingFunc: Function): void
      /**
       ...
       * @since 8.8.4
       */
      public transitionFromSolo(container: HTMLElement): void
      /**
       ...
       * @since 8.6.0
       */
      public toggleSolo(container: HTMLElement, config: object): void
      /**
       ...
       * @since 8.6.0
       */
      public setColCount(container: HTMLElement): void
      /**
       ...
       * @since 8.8.0
       */
      public setRowCount(container: HTMLElement): void
      /**
       ...
       * @since 8.8.0
       */
      public setGridTemplate(container: HTMLElement): void
      /**
       ...
       * @since 8.8.0
       */
      public cleanGridStyles(container: HTMLElement): void
      /**
       ...
       * @since 8.8.0
       */
      public fillLayoutWithCharts(container: HTMLElement): void
      /**
       ...
       * @since 8.6.0
       */
      public updateGridListener(container: HTMLElement): void
      /**
       ...
       * @since 8.6.0
       */
      public updateLayout(container: HTMLElement, config: object): void
      /**
       * Copies attributes ending with "-feature" from the source to the target element.
       *
       * @param fromEl Source element.
       * @param toEl Target element.
       *
       * @since 8.6.0
       */
      public copyAttributes(fromEl: HTMLElement, toEl: HTMLElement): void
      /**
       * Gets an array of shared UI elements that are context-switch aware.
       *
       * @param container Chart wrapper container.
       * @return An array of components in the common UI that control each of the multi-charts
       *
       * @since 8.6.0
       */
      public getCommonUI(container: HTMLElement): HTMLElement[]
      /**
       ...
       * @param gridTemplate Template class name.
       *
       * @since 8.6.0
       */
      public setGridUI(
       ...
       * @since 8.6.0
       */
      public utils(container: HTMLElement): void
    }
    /**
     *
     *
    ...
    class BaseComponent extends HTMLElement {
       ...
       * Up to two events are emitted when this function is executed.  The first is an event with the type of action performed, if there is one.
       ...
       *
       * @param params
       * @param [params.cause] The cause of the event. e.g., useraction, timeout, alert. Defaults to "useraction" if not set and `action` parameter is set.
       * @param [params.effect] The effect of the user's action.  Required if not provided in `detail`. e.g., open, help, toggle, select.
       * @param [params.action="click"] The action a user performed, if applicable. e.g. click, longpress, drag.  Set to null if no user action was performed.
       * @param [params.detail={}] Optional extra parameters to include in the detail of the Custom Event.
       *
       * @since
       * - 8.9.0
       ...
       *
       * @param path The CSS selectors to find.
       * @param root The root element, which is the starting
       * 		point of the DOM query, or "thisChart" to indicate the chart context in which this
       * 		function is called.
       * @param bustShadowRoots Set to true to penetrate shadow root boundaries.
       * @return An array of selected DOM element.
       *
       * @since
       * - 7.5.0
       ...
       * @since 9.1.0
       */
      public trimInnerHTMLWhitespace(): String
      /**
       ...
       * @return The newly focused element if a `cq-focused` attribute has changed.
       *
       * @since 8.3.0
       ...
       */
      public focusNextItem(items: NodeList, reverse?: boolean, loop?: boolean): HTMLElement|undefined
      /**
     ...
     * @see WebComponents
     */
    class ContextTag extends CIQ.UI.BaseComponent {
      /**
     ...
     * @see WebComponents
     */
    class ModalTag extends CIQ.UI.ContextTag {
      /**
     ...
     * @see WebComponents
     */
    class DialogContentTag extends CIQ.UI.BaseComponent {
      /**
       * Closes the dialog.
       *
       * Designed to be used as a helper method for the included WebComponents. A full
       ...
       * @param element Element to query selectors from.
       * @return Array containing all tab navigable elements.
       *
       * @since 8.8.0
       */
      public naturalTabElements(element: HTMLElement): HTMLElement[]
      /**
       ...
       *
       */
      public open(params?: {caller?: HTMLElement, context?: CIQ.UI.Context}): void
      /**
     ...
     *
     * Designed to be used as a helper method for the included WebComponents. A full tutorial
    ...
    class UIManager extends HTMLElement {
       ...
       *
       * @param el Element for which to get color picker
       *
       * @return Color picker from the element context
       *
       * @since 8.9.2
       */
      public getColorPicker(el: HTMLElement): CIQ.UI.ColorPicker
      /**
       * Close open color picker
       *
       * @since 8.9.2
       */
      public closeOpenColorPicker(): void
      /**
       ...
       * 		menus are closed.
       * @param [tagFilter] Accepts a comma delimited list of tagNames and closes only matching tags.
       * @since 8.7.0 Modified `tagFilter` parameter to accept a comma seperated list of tag names.
       */
      public closeMenu(menu?: HTMLElement, tagFilter?: string): void
      /**
     ...
     * See CIQ.UI.BaseComponent#addClaim and CIQ.UI.BaseComponent#removeClaim.
     *
     * @since 8.9.0
     */
    let keyboardClaims: Set<HTMLElement>
    /**
     * Map of components which use shadow DOM.
     *
     * @since 8.9.0
     */
    let shadowComponents: Map<HTMLElement, HTMLElement>
    /**
     ...
     * @since 9.1.0
     */
    let addAttributeOnPropertyChange: boolean
    /**
     ...
     * @param [node] A node within the context.
     *
     * @example
     ...
     *
     */
    function contextsForEach(func: Function, node?: HTMLElement): void
    /**
     ...
     *
     * @param component A web component instance.
     * @param classDefinition Class definition that identifies a component.
     *
     * @since 8.5.0
     */
    function flattenInheritance(component: object, classDefinition: Function): void
    /**
     ...
     *
     * @param el The element whose ancestry to check
     * @param [options] Selection options
     * @param [options.isWrapper=false] If true, will check for a cq-context-wrapper element instead of a cq-context element.
     * @param [options.includeSelf=false] If true, will check itself before checking ancestry.
     * @return The ancestor context or wrapper element.
     *
     * @since 8.9.0
     */
    function closestContextContainer(
      el: HTMLElement,
      options?: {
        isWrapper?: boolean,
        includeSelf?: boolean
     ...
     * @since 8.4.0
     */
    let defaultSwatchColors: string[]
    /**
    ...
    /**
     * Obtains a reference to the document's [cq-ui-manager]WebComponents.UIManager
     ...
     * document.
     *
     * @param [element] Pass an element to give a hint as to where to find the UI Manager.
     * @return A reference to the document's UI manager.
     *
     * @since
     * - 7.5.0
     * - 8.5.0 Added `element` parameter.
     */
    function getUIManager(element?: Element): CIQ.UI.UIManager
    /**
     ...
     *
     * @param context uiContext to operate on. Will traverse down from topNode
     * @static
     * @since 8.7.0
     */
    function setDefaultStates(context: CIQ.UI.Context): void
  }
  ...
  export namespace CIQ {
    ...
    class UI {
       ...
       * 		Faquery.
       * @return A jQuery object if jQuery is enabled and `force` is false; otherwise,
  ...
  export class Faquery {
     ...
     * Add css classes.
     *
     * @param classes List of classes, either space delimited or an array.
     * @return Returns itself.
     */
    public addClass(classes: string|string[]): Faquery
    /**
     * Append DOM elements.
     *
     * @param content DOM to append.  If a string, will set inner content.
     * @param invalid Not used.  Faquery.append does not accept a second argument like jQuery does.
     * @return Returns itself
     */
    public append(
      content: string|string[]|Faquery|HTMLElement|HTMLElement[],
      invalid: undefined
    ): Faquery
    /**
     ...
     *
     * @param nameOrObject Attribute name or an object with name-value pairs.
     * @param [value] If supplied, will set the attribute whose name is specified in `nameOrObject` (if a string).
     * @return Returns itself if setting an attribute, or the attribute's value if getting an attribute.
     */
    public attr(nameOrObject: string|Object, value?: string): Faquery|string
    /**
     * Get child elements.
     *
     * @param selector Selector for children to get.
     * @return Returns children.
     */
    public children(selector: string): Faquery
    /**
     ...
     *
     * @param nameOrObject Style property name or an object with name-value pairs.
     * @param [value] If supplied, will set the property whose name is specified in `nameOrObject` (if a string).
     * @return Returns itself if setting a property, or the property's value if getting a property.
     */
    public css(nameOrObject: string|Object, value?: string): Faquery|string
    /**
     * Call a function on each element.
     *
     * @param func Function to call.  Signature is: first parameter is the index, second is the element. `this` is available as the element being iterated.
     * @return Returns itself.
     */
    public each(func: Function): Faquery
    /**
     * Remove content from element(s).
     *
     * @return Returns itself.
     */
    public empty(): Faquery
    /**
     * Find descendant elements.
     *
     * @param selector Selector for descendants to get.
     * @return Returns descendants.
     */
    public find(selector: string): Faquery
    /**
     * Test if any element contains a class.
     *
     * @param className Name of class to test.
     * @return True if at least one element has the class.
     */
     ...
     *
     * @param [value] If setting, value to set innerHTML to.
     * @return Returns itself if setting, or innerHTML if getting.
     */
    public html(value?: string): Faquery|string
    /**
     * Find subsequent sibling elements.
     *
     * @param selector Selector for siblings to get.
     * @return Returns subsequent siblings.
     */
    public nextAll(selector: string): Faquery
    /**
     * Get nonmatching elements.
     *
     * @param selector Selector for elements to omit.
     * @return Returns nonmatching elements.
     */
    public not(selector: string): Faquery
    /**
     * Get parent elements.
     *
     * @param selector Selector for parent to get.
     * @return Returns matching parents.
     */
    public parent(selector: string): Faquery
    /**
     * Get ancestors.
     *
     * @param selector Selector for ancestors to get.
     * @return Returns matching ancestors.
     */
    public parents(selector: string): Faquery
    /**
     ...
     *
     * @param nameOrObject Property name or an object with name-value pairs.
     * @param [value] If supplied, will set the property whose name is specified in `nameOrObject` (if a string).
     * @return Returns itself if setting a property, or the property's value if getting a property.
     */
    public prop(nameOrObject: string|Object, value?: string): Faquery|string
    /**
     * Remove elements from DOM that match a selector.
     *
     * @param selector Query selector to match.
     * @return Returns itself.
     */
    public remove(selector: string): Faquery
    /**
     * Remove HTML attributes.
     *
     * @param attributes Attribute name(s) to remove.
     * @return Returns itself.
     */
    public removeAttr(attributes: string|string[]): Faquery
    /**
     * Remove css classes.
     *
     * @param classes List of classes, either space delimited or an array.
     * @return Returns itself.
     */
    public removeClass(classes: string|string[]): Faquery
    /**
     ...
     *
     * @param [value] If setting, value to set innerText to.
     * @return Returns itself if setting, or innerText if getting.
     */
    public text(value?: string): Faquery|string
    /**
     * Set/Get value property.  If `value` not supplied, will return existing `value` property value.
     *
     * @param [value] If setting, value to set `value` property to.
     * @return Returns itself if setting, or value of `value` property if getting.
     */
    public val(value?: string): Faquery|string
  }
   ...
   * @since 7.5.0
   */
  export namespace CIQ.UI.Chart {
    /**
     * Dynamically loads and applies plug-in to the chart engine.
     *
     * Requires plugin load fuction containing dynamic import to be available
     *
     * @param stx A reference to the chart engine.
     ...
     * @since 9.0.0
     */
    function loadPlugin(stx: CIQ.ChartEngine, pluginName: string): void
  }
}
