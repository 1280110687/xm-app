...
let __js_webcomponents_legacy_abstractMarker_ = (_exports) => {
...
let __js_webcomponents_legacy_advertisement_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    class Advertisement extends CIQ.UI.ModalTag {
      ...
      close() {
        ...
        this.nameValueStore.get("cq-advertisement", function (err, ls) {
          ...
          var future = new Date();
          if (!self.sleepAmount)
            self.sleepAmount = { units: 1, unitType: "day" };
...
let __js_webcomponents_legacy_aggregationDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    open(params) {
      ...
      for (var type in map) {
        node
          .find(".ciq" + type)
          .css(
            aggregationType === type ? { display: "" } : { display: "none" },
          );
      }
...
let __js_webcomponents_legacy_attribution_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_chartLegend_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_chartTitle_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class ChartTitle extends CIQ.UI.ModalTag {
    ...
    update() {
      ...
      const {
        chart: { symbol, symbolObject, symbolDisplay },
        internationalizer,
      } = stx;
      ...
      const symbolValue = symbolObject.display || symbol;

      if (symbolDiv.innerText !== symbolValue) {
        symbolDiv.innerText = symbolValue;
        symbolChanged = true;
      }
...
let __js_webcomponents_legacy_chartcontrolGroup_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_clickable_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_close_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_comparison_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class Comparison extends CIQ.UI.ModalTag {
      ...
      switch (key) {
        ...
        case "Tab":
          ...
          if (newFocused.tagName == "CQ-LOOKUP") {
            ...
            if (newFocused.onKeyboardSelection)
              newFocused.onKeyboardSelection();
    ...
    position() {
      ...
      function printValues() {
        ...
        for (var s in stx.chart.series) {
          ...
          var price = key.find(
            'cq-comparison-item[cq-symbol="' +
              s +
              '"] cq-comparison-tick-price',
          );
    ...
    renderLegend() {
      ...
      for (var r in stx.chart.seriesRenderers) {
        ...
        if (
          panelOnly &&
          (!holder || renderer.params.panel != holder.panel.name)
        )
          continue;
        for (var s = 0; s < renderer.seriesParams.length; s++) {
          ...
          var color =
            seriesParameters.color || renderer.colors[series.id].color;
      ...
      var legendParent = CIQ.climbUpDomTree(
        CIQ.cqrender(key),
        "cq-study-legend",
      );
    ...
    startPriceTracker(updatePrices) {
      ...
      this.addInjection("append", "createDataSet", function () {
        ...
        } else if (self.hasAttribute("cq-show"))
          self.removeAttribute("cq-show");
      });
    }
    ...
    setContext(context) {
      ...
      ["layout", "symbolImport", "symbolChange", "theme"].forEach(
        function (ev) {
...
let __js_webcomponents_legacy_comparisonLookup_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_cvpController_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class CVPController extends CIQ.UI.ContextTag {
    ...
    get lineWidth() {
      return this.context.stx.currentVectorParameters[
        "lineWidth" + this._scope
      ];
    }
...
let __js_webcomponents_legacy_dataDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class DataDialog extends CIQ.UI.DialogContentTag {
    ...
    showData() {
      ...
      for (const entries of this.fileMap) {
        ...
        const periodicity = frag.querySelector(
          ".ciq-select[name='periodicity']",
        );
...
let __js_webcomponents_legacy_dialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_drawingContext_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_fibSettingsDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_gridSizePicker_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class GridSizePicker extends CIQ.UI.BaseComponent {
    ...
    highlightTable(columns, rows) {
      for (let gridCell of this.querySelectorAll("td")) {
        if (
          gridCell.dataset.column <= columns &&
          gridCell.dataset.row <= rows
        ) {
...
let __js_webcomponents_legacy_heading_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_help_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class Help extends CIQ.UI.ContextTag {
    connectedCallback() {
      ...
      ["mousedown", "pointerdown", "touchstart"].forEach((eventName) =>
        this.addEventListener(eventName, this.mouseTouchDown, {
          passive: false,
        }),
      );
      ["mouseup", "pointerup", "touchend", "touchmove", "click"].forEach(
        (eventName) =>
          this.addEventListener(eventName, this.mouseTouchUp, {
            passive: false,
          }),
      );
    }
...
let __js_webcomponents_legacy_infoToggle_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class InfoToggle extends CIQ.UI.ContextTag {
    ...
    initInfoComponents(context) {
      const toggles =
        this.querySelector("cq-toggle").getAttribute("cq-toggles");
...
let __js_webcomponents_legacy_infoToggleDropdown_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class InfoToggleDropdown extends CIQ.UI.ContextTag {
    ...
    set(value) {
      ...
      options.forEach((option) => {
        ...
        if (type) {
          newLayoutValues[member] = Object.assign(
            newLayoutValues[member] || {},
            {
              [type]: valueToSet,
            },
          );
...
let __js_webcomponents_legacy_languageDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  if (!CIQ.I18N) {
    ...
    class LanguageDialog extends CIQ.UI.DialogContentTag {
      ...
      close() {
        const langDialog =
          this.ownerDocument.querySelector("cq-language-dialog");
...
let __js_webcomponents_legacy_lookup_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    class Lookup extends CIQ.UI.ContextTag {
      ...
      close() {
        if (this.keyboardNavigation) {
          ...
          const keystrokeHub = this.ownerDocument.body.keystrokeHub;
          if (keystrokeHub)
            setTimeout(() => keystrokeHub.highlightAlign(), 250);
        }
      ...
      keyStroke(hub, key, e, keystroke) {
        ...
        switch (key) {
          ...
          case "Enter":
            ...
            if ((input.value === "" && !focused) || this.overrideIsActive)
              break;
            if (focused && focused.selectFC) {
              ...
              var val = input.value;
              var toUpperCase =
                ["false", "0", null].indexOf(
                  this.getAttribute("cq-uppercase"),
                ) == -1;
...
let __js_webcomponents_legacy_lookupDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class LookupDialog extends CIQ.UI.DialogContentTag {
    ...
    initialize() {
      ...
      this.verticalStructure = LookupDialog.verticalStructure.map(
        (selector) => {
...
let __js_webcomponents_legacy_measurementLineSettingsDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_menu_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class Menu extends HTMLElement {
    ...
    show(params) {
      ...
      this.querySelectorAll("cq-scroll, cq-menu-dropdown").forEach(
        function (s) {
...
let __js_webcomponents_legacy_menuContainer_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_messageToaster_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  class MessageToaster extends CIQ.UI.ContextTag {
    ...
    positionElement(messageElement) {
      const canvasBounds =
        this.context.stx.chart.canvas.getBoundingClientRect();
    ...
    displayNextMessage() {
      ...
      let messageNodes =
        this.context.topNode.querySelector(".cq-toast-message");
      if (!messageNodes) {
...
let __js_webcomponents_legacy_palette_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_shareButton_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_shareDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_showRange_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_sideNav_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_sidePanel_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_studies_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    updateOrder() {
      ...
      CIQ.Studies.Favorites.retrieveList(stx, (favoriteList) => {
        ...
        list.sort(sortFunction).forEach((item) => {
          item.classList[favorites[item.type] ? "add" : "remove"](
            "ciq-favorite",
          );
...
let __js_webcomponents_legacy_studyContext_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_studyDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
        ...
        for (var i = 0; i < this.helper.inputs.length; i++) {
          ...
          if (input.type == "number") {
            ...
            formField.setAttribute(
              "type",
              CIQ.UI.supportedInputType(input.type),
            );
            if (input.type == "date")
...
let __js_webcomponents_legacy_studyInput_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_studyLegend_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  if (!CIQ.Studies) {
    ...
    class StudyLegend extends CIQ.UI.ModalTag {
      ...
      changeContext(newContext) {
        ...
        this.eventListeners = [
          newContext.stx.addEventListener(
            "layout",
            this.renderLegend.bind(this),
          ),
          newContext.stx.addEventListener(
            "theme",
            this.renderLegend.bind(this),
...
let __js_webcomponents_legacy_studyMenuManager_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_studyOutput_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_studyParameter_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_swatch_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_themeDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    class ThemeDialog extends CIQ.UI.DialogContentTag {
      ...
      save() {
        ...
        this.context.topNode.CIQ.UI.Components.filter(
          (n) =>
            n.matches("cq-themes") && n.ownerDocument === this.ownerDocument,
        ).forEach((t) => {
...
let __js_webcomponents_legacy_themePiece_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_themes_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_timezoneDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_toggle_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_toolbar_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  if (!CIQ.Drawing) {
    console.error(
      "toolbar component requires first activating drawing feature.",
    );
  } else {
    /**
...
let __js_webcomponents_legacy_viewDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_views_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_volumeProfileSettingsDialog_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_waveParameters_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_dialog_colorPicker_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
...
let __js_webcomponents_legacy_palette_drawingPalette_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
    ...
    class DrawingPalette extends Palette.classDefinition {
      ...
      setupKeyboardActivation(context) {
        if (typeof this.getAttribute("cq-keystroke-claim") != "undefined") {
          ...
          for (let idx = 0; idx < toolsWithShortcuts.length; idx++) {
            let letter =
              toolsWithShortcuts[idx].getAttribute("cq-tool-shortcut");
      ...
      setFavorites(propagateSettings = true) {
        ...
        for (
          ...
          if (
            toolButton.getAttribute("cq-tool-group").indexOf("favorite") >= 0
          ) {
...
let __js_webcomponents_legacy_palette_drawingSettings_ = (_exports) => {
  /* global _CIQ, _timezoneJS, _SplinePlotter */
  ...
  if (!Palette) {
    ...
    class DrawingSettings extends Palette.classDefinition {
      ...
      setActiveToolLabel(activeToolLabel) {
        ...
        this.querySelector(".ciq-active-tool-label").innerHTML =
          activeToolLabel;
      ...
      toggleCheckbox(activator, id) {
        ...
        if (id === "showCallout") {
          ["fontOptions", "fillColor"].forEach((name) =>
            this.params[name][cvp[id] ? "addClass" : "removeClass"](
              "ciq-active",
            ),
          );
        }
...
export { __js_webcomponents_legacy_abstractMarker_ as abstractMarker };
export { __js_webcomponents_legacy_advertisement_ as advertisement };
export { __js_webcomponents_legacy_aggregationDialog_ as aggregationDialog };
export { __js_webcomponents_legacy_attribution_ as attribution };
export { __js_webcomponents_legacy_chartLegend_ as chartLegend };
export { __js_webcomponents_legacy_chartTitle_ as chartTitle };
export { __js_webcomponents_legacy_chartcontrolGroup_ as chartcontrolGroup };
export { __js_webcomponents_legacy_clickable_ as clickable };
export { __js_webcomponents_legacy_close_ as close };
export { __js_webcomponents_legacy_comparison_ as comparison };
export { __js_webcomponents_legacy_comparisonLookup_ as comparisonLookup };
export { __js_webcomponents_legacy_cvpController_ as cvpController };
export { __js_webcomponents_legacy_dataDialog_ as dataDialog };
export { __js_webcomponents_legacy_dialog_ as dialog };
export { __js_webcomponents_legacy_drawingContext_ as drawingContext };
export { __js_webcomponents_legacy_fibSettingsDialog_ as fibSettingsDialog };
export { __js_webcomponents_legacy_gridSizePicker_ as gridSizePicker };
export { __js_webcomponents_legacy_heading_ as heading };
export { __js_webcomponents_legacy_help_ as help };
export { __js_webcomponents_legacy_infoToggle_ as infoToggle };
export { __js_webcomponents_legacy_infoToggleDropdown_ as infoToggleDropdown };
export { __js_webcomponents_legacy_languageDialog_ as languageDialog };
export { __js_webcomponents_legacy_lookup_ as lookup };
export { __js_webcomponents_legacy_lookupDialog_ as lookupDialog };
export { __js_webcomponents_legacy_measurementLineSettingsDialog_ as measurementLineSettingsDialog };
export { __js_webcomponents_legacy_menu_ as menu };
export { __js_webcomponents_legacy_menuContainer_ as menuContainer };
export { __js_webcomponents_legacy_messageToaster_ as messageToaster };
export { __js_webcomponents_legacy_palette_ as palette };
export { __js_webcomponents_legacy_shareButton_ as shareButton };
export { __js_webcomponents_legacy_shareDialog_ as shareDialog };
export { __js_webcomponents_legacy_showRange_ as showRange };
export { __js_webcomponents_legacy_sideNav_ as sideNav };
export { __js_webcomponents_legacy_sidePanel_ as sidePanel };
export { __js_webcomponents_legacy_studies_ as studies };
export { __js_webcomponents_legacy_studyContext_ as studyContext };
export { __js_webcomponents_legacy_studyDialog_ as studyDialog };
export { __js_webcomponents_legacy_studyInput_ as studyInput };
export { __js_webcomponents_legacy_studyLegend_ as studyLegend };
export { __js_webcomponents_legacy_studyMenuManager_ as studyMenuManager };
export { __js_webcomponents_legacy_studyOutput_ as studyOutput };
export { __js_webcomponents_legacy_studyParameter_ as studyParameter };
export { __js_webcomponents_legacy_swatch_ as swatch };
export { __js_webcomponents_legacy_themeDialog_ as themeDialog };
export { __js_webcomponents_legacy_themePiece_ as themePiece };
export { __js_webcomponents_legacy_themes_ as themes };
export { __js_webcomponents_legacy_timezoneDialog_ as timezoneDialog };
export { __js_webcomponents_legacy_toggle_ as toggle };
export { __js_webcomponents_legacy_toolbar_ as toolbar };
export { __js_webcomponents_legacy_viewDialog_ as viewDialog };
export { __js_webcomponents_legacy_views_ as views };
export { __js_webcomponents_legacy_volumeProfileSettingsDialog_ as volumeProfileSettingsDialog };
export { __js_webcomponents_legacy_waveParameters_ as waveParameters };
export { __js_webcomponents_legacy_dialog_colorPicker_ as colorPicker };
export { __js_webcomponents_legacy_palette_drawingPalette_ as drawingPalette };
export { __js_webcomponents_legacy_palette_drawingSettings_ as drawingSettings };
...
if (typeof __TREE_SHAKE__ === "undefined" || !__TREE_SHAKE__) {
  _exports.CIQ.activateImports(
    __js_webcomponents_legacy_abstractMarker_,
    __js_webcomponents_legacy_advertisement_,
    __js_webcomponents_legacy_aggregationDialog_,
    __js_webcomponents_legacy_attribution_,
    __js_webcomponents_legacy_chartLegend_,
    __js_webcomponents_legacy_chartTitle_,
    __js_webcomponents_legacy_chartcontrolGroup_,
    __js_webcomponents_legacy_clickable_,
    __js_webcomponents_legacy_close_,
    __js_webcomponents_legacy_comparison_,
    __js_webcomponents_legacy_comparisonLookup_,
    __js_webcomponents_legacy_cvpController_,
    __js_webcomponents_legacy_dataDialog_,
    __js_webcomponents_legacy_dialog_,
    __js_webcomponents_legacy_drawingContext_,
    __js_webcomponents_legacy_fibSettingsDialog_,
    __js_webcomponents_legacy_gridSizePicker_,
    __js_webcomponents_legacy_heading_,
    __js_webcomponents_legacy_help_,
    __js_webcomponents_legacy_infoToggle_,
    __js_webcomponents_legacy_infoToggleDropdown_,
    __js_webcomponents_legacy_languageDialog_,
    __js_webcomponents_legacy_lookup_,
    __js_webcomponents_legacy_lookupDialog_,
    __js_webcomponents_legacy_measurementLineSettingsDialog_,
    __js_webcomponents_legacy_menu_,
    __js_webcomponents_legacy_menuContainer_,
    __js_webcomponents_legacy_messageToaster_,
    __js_webcomponents_legacy_palette_,
    __js_webcomponents_legacy_shareButton_,
    __js_webcomponents_legacy_shareDialog_,
    __js_webcomponents_legacy_showRange_,
    __js_webcomponents_legacy_sideNav_,
    __js_webcomponents_legacy_sidePanel_,
    __js_webcomponents_legacy_studies_,
    __js_webcomponents_legacy_studyContext_,
    __js_webcomponents_legacy_studyDialog_,
    __js_webcomponents_legacy_studyInput_,
    __js_webcomponents_legacy_studyLegend_,
    __js_webcomponents_legacy_studyMenuManager_,
    __js_webcomponents_legacy_studyOutput_,
    __js_webcomponents_legacy_studyParameter_,
    __js_webcomponents_legacy_swatch_,
    __js_webcomponents_legacy_themeDialog_,
    __js_webcomponents_legacy_themePiece_,
    __js_webcomponents_legacy_themes_,
    __js_webcomponents_legacy_timezoneDialog_,
    __js_webcomponents_legacy_toggle_,
    __js_webcomponents_legacy_toolbar_,
    __js_webcomponents_legacy_viewDialog_,
    __js_webcomponents_legacy_views_,
    __js_webcomponents_legacy_volumeProfileSettingsDialog_,
    __js_webcomponents_legacy_waveParameters_,
    __js_webcomponents_legacy_dialog_colorPicker_,
    __js_webcomponents_legacy_palette_drawingPalette_,
    __js_webcomponents_legacy_palette_drawingSettings_,
    null,
  );
}
