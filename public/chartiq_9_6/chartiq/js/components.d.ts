...
declare module '../js/components.js' {
  ...
  export namespace WebComponents {
    ...
    class DoubleSlider extends CIQ.UI.BaseComponent {
       ...
       *
       * @param bounds Contains min, max, and step values.
       *
       * @since 8.3.0
       */
      public setBounds(bounds: object): void
      /**
       * Sets the high and low values of the slider.
       *
       * The high and low values are restricted to the range of the max and min.
       *
       * @param [data] Contains high and low values.
       *
       * @since 8.3.0
       */
    ...
    class GridSizePicker extends CIQ.UI.BaseComponent {
       ...
       *
       * @param columns Table column count
       * @param rows Table row count
       *
       */
      public generateTable(columns: number, rows: number): void
      /**
       * Highlights provided number of rows and columns
       *
       * @param columns Columns to highlight
       * @param rows Rows to highlight
       *
       */
      public highlightTable(columns: number, rows: number): void
      /**
       * Applies highlight on the idenified template
       *
       * @param gridTemplate Template to highlight
       *
       */
      public highlightTemplate(gridTemplate: string|undefined): void
      /**
       * Removes unused rows and columns in the grid size picker table
       *
       * @param columns Columns to keep
       * @param rows Rows to keep
       *
       */
      public cleanTable(columns: number, rows: number): void
      /**
    ...
    class Loader extends CIQ.UI.ContextTag {
       ...
       *
       * @param [applyClass=false] Applies the ciq-loading-data class to the chart container, which by default dims the chart.
       *
       * @since 9.4.0 added applyClass parameter
       *
       */
      public show(applyClass?: boolean): void
      /**
    ...
    class Lookup extends CIQ.UI.ContextTag {
       ...
       *
       */
      public results(arr: object[]): void
      /**
    ...
    class LookupDialog extends CIQ.UI.DialogContentTag {
       ...
       * @param [params.callback] callback called when an item is selected.
       * @param [params.useFirstResult] whether to return the first result when hitting enter.
       *
    ...
    class SidePanel extends CIQ.UI.ContextTag {
      ...
      public setContext(context: CIQ.UI.Context): void
      /**
       * Closes the side panel and all of its child plugins which were opened using the WebComponents.SidePanel#open function.
       *
       */
      public close(): void
      /**
    ...
    class StudyDialog extends CIQ.UI.DialogContentTag {
       ...
       *
       * @param activator
       * @param activator.node The corresponding line style dropdown.
       * @param width The selected line width.
       * @param pattern The selected line pattern.
       *
       */
      public setLine(
        activator: {
    ...
    class SymbolInput extends CIQ.UI.ContextTag {
       ...
       * @param params Parameters
       * @param [params.value] Input symbol
       *
       */
      public initialize(params: {value?: String}): void
      /**
    ...
    class YAxisContext extends CIQ.UI.DialogContentTag {
       ...
       *
       * @param activator The object representing menuItem chosen.
       * @param type Action type, e.g. "move", "merge", "unmerge" or "transform".
       * @param option Parameter for the action, e.g. "left" or "right" Move or Merge direction or transform type.
       *
       */
      public updateYAxis(activator: object, type: string, option: string): void
    }
    /**
     *
     *
  ...
  export namespace CIQ.UI {
    interface DialogContentTag {
      /**
       * Configure CSS layering to enable the color picker to float above the dialog.
       *
       * @param [val=true] Setting "val" to false will restore the original style values of the element.
       *
       * @since 9.3.0
       */
      enableMultichartColorPickerFloat(val?: boolean): void
    }
  }
   ...
   * @since 9.3.0 Added new emitter
   */
  export namespace WebComponents.GridSizePicker {
    /**
   ...
   * @since 9.5.0
   */
  export namespace WebComponents.SymbolInput {
    /**
     * Default markup for the component's innerHTML, to be used when the component is added to the DOM without any innerHTML.
     *
     * @static
...
export function abstractMarker(_export: object): void
export function advertisement(_export: object): void
export function aggregationDialog(_export: object): void
export function attribution(_export: object): void
export function chartInstructions(_export: object): void
export function chartTitle(_export: object): void
export function clickable(_export: object): void
export function close(_export: object): void
export function comparison(_export: object): void
export function cvpController(_export: object): void
export function dataDialog(_export: object): void
export function dialog(_export: object): void
export function doubleSlider(_export: object): void
export function drawingContext(_export: object): void
export function dropdown(_export: object): void
export function fibSettingsDialog(_export: object): void
export function floatingWindow(_export: object): void
export function gridSizePicker(_export: object): void
export function heading(_export: object): void
export function headsupDynamic(_export: object): void
export function headsupStatic(_export: object): void
export function help(_export: object): void
export function instantChart(_export: object): void
export function languageDialog(_export: object): void
export function loader(_export: object): void
export function lookup(_export: object): void
export function lookupDialog(_export: object): void
export function marker(_export: object): void
export function measurementLineSettingsDialog(_export: object): void
export function menu(_export: object): void
export function messageToaster(_export: object): void
export function palette(_export: object): void
export function paletteDock(_export: object): void
export function redo(_export: object): void
export function scroll(_export: object): void
export function shareButton(_export: object): void
export function shareDialog(_export: object): void
export function showRange(_export: object): void
export function sideNav(_export: object): void
export function sidePanel(_export: object): void
export function studies(_export: object): void
export function studyContext(_export: object): void
export function studyDialog(_export: object): void
export function studyLegend(_export: object): void
export function swatch(_export: object): void
export function symbolInput(_export: object): void
export function themeDialog(_export: object): void
export function themes(_export: object): void
export function timezoneDialog(_export: object): void
export function toggle(_export: object): void
export function typedefs(_export: object): void
export function undo(_export: object): void
export function viewDialog(_export: object): void
export function views(_export: object): void
export function volumeProfileSettingsDialog(_export: object): void
export function waveParameters(_export: object): void
export function yAxisContext(_export: object): void
export function colorPicker(_export: object): void
export function drawingPalette(_export: object): void
export function drawingSettings(_export: object): void
export function menuDropdown(_export: object): void