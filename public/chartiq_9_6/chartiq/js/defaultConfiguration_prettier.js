...
/**
 * @timport { CIQ } from './chartiq.js';
 * @tsmodule ./defaultConfiguration.js
 */
/**
 * @typedef Content
 * @desc Menu content parameters
 * @property {string} type
 * @property {string} [label]
 * @property {string} [tap]
 * @property {boolean} [menuPersist]
 * @property {string} [iconCls]
 * @property {string} [cls]
 * @property {string} [cmd]
 * @property {string} [feature]
 * @property {string} [method]
 * @property {string} [filterFor]
 * @property {number} [filterMin]
 * @property {string} [helpId]
 * @property {string} [options]
 * @property {string} [setget]
 * @property {string} [className]
 * @property {string} [id]
 * @property {string | string[] | number[] | Record<string, string | number>} [value]
 * @property {Record<string, string>} [attributes]
 */
/**
 * @typedef Resources
 * @desc resources that can be passed into the configuration object using getConfig()
 * @property {CIQ.NameValueStore} [nameValueStore]
 * @property {boolean} [deprecatedSettings]
 * @property {object} [quoteFeed]
 * @property {object} [forecastQuoteFeed]
 * @property {object} [markerFeed]
 * @property {object} [chartSharing]
 * @property {object} [emojiPicker]
 * @property {object} [scrollStyle]
 */
/**
 * @typedef Config
 * @desc configuration properties
 * @property {string | InitialSymbol} initialSymbol
 * @property {string} [chartId]
 * @property {Document} root
 * @property {undefined} initialData
 * @property {EnabledAddOns} enabledAddOns
 * @property {OnNewSymbolLoad} onNewSymbolLoad
 * @property {boolean} restore
 * @property {boolean} setHtmlLang
 * @property {object} lookupDriver
 * @property {HotKeyConfig} hotkeyConfig
 * @property {Record<string, SystemMessage>} systemMessages
 * @property {Record<string, MarketName>} marketDefinitionAPIs
 * @property {string} marketDefinitionDefaultMapping
 * @property {Record<string, string>} marketDefinitionMapping
 * @property {function(symbolObject: object): object} marketFactory
 * @property {ChartEngineParams} chartEngineParams
 * @property {QuoteFeeds[]} quoteFeeds
 * @property {Selector} selector
 * @property {Themes} themes
 * @property {boolean} displayStyleIcons
 * @property {object} menuViewConfig
 * @property {MenuStudiesConfig} menuStudiesConfig
 * @property {DrawingTools[]} drawingTools
 * @property {string[]} drawingToolGrouping
 * @property {MenuRendering} menuRendering
 * @property {AddOns} addOns
 * @property {Plugins} plugins
 * @property {Channels} channels
 * @property {Record<string, Dialog>} dialogs
 * @property {object} [eventMarkersImplementation]
 * @property {ScrollbarStyling} scrollbarStyling
 * @property {object} [chartSharing]
 * @property {null} multiChartCopySymbol
 * @property {string} multiChartLoadMsg
 * @property {boolean} restoreOffgridCharts
 * @property {CIQ.NameValueStore} nameValueStore
 * @property {SoloActive} soloActive
 * @property {UseQueryString} useQueryString
 * @property {string[] | null} ariaActive
 * @property {object} studyOutputAliasList
 * @property {object} abstractMarkers
 * @property {Attributions} attributions
 * @property {Groups} groups
 * @property {Menus} menus
 * @property {Toggles} toggles
 * @property {Content[]} [menuChartStyle]
 * @property {Content[]} [menuChartAggregates]
 * @property {Content[]} [menuPeriodicity]
 * @property {Content[]} [menuChartPreferences]
 * @property {Content[]} [menuYaxisField]
 * @property {Content[]} [menuYAxisPreferences]
 * @property {Content[]} [menuAddOns]
 * @property {Content[]} [rangeMenu]
 * @property {function(): void} updateFromQueryString
 * @property {function(): void} onWebComponentsReady
 * @property {function(stx: CIQ.ChartEngine): void} onEngineReady
 * @property {function(stx: CIQ.ChartEngine): void} onChartReady
 * @property {function(type: string, details: object): void} onMultiChartEvent
 * @property {function(name: string, sort: boolean|function): string[]} getMenu
 * @property {function(container: HTMLElement): CIQ.ChartEngine} createChart
 */
const defaultConfig = (resources) => {
  return {
     ...
     * @typedef InitialSymbol
     * @property {string} symbol
     * @property {string} [name]
     * @property {string} [exchDisp]
     */
    initialSymbol: {
      symbol: "AAPL",
      name: "Apple Inc",
    ...
    // List of addons and their enabled status at chart initialization.
    // Either override or supplement this list before creating chart to modify.
    /**
     * @typedef EnabledAddOns
     * @desc config.enabledAddOns
     * @property {boolean} animation
     * @property {boolean} continuousZoom
     * @property {boolean} forecasting
     * @property {boolean} outliers
     * @property {boolean} dataLoader
     * @property {boolean} extendedHours
     * @property {boolean} fullScreen
     * @property {boolean} inactivityTimer
     * @property {boolean} rangeSlider
     * @property {boolean} shortcuts
     * @property {boolean} tableView
     ...
     * @typedef AddOns
     * @desc config.addOns
     * @property {TooltipAddOn} tooltip
     * @property {InactivityTimerAddOn} inactivityTimer
     * @property {AnimationAddOn} animation
     * @property {object} outliers
     * @property {object} rangeSlider
     * @property {object} fullScreen
     * @property {ExtendedHoursAddOn} extendedHours
     * @property {ContinuousZoomAddOn} continuousZoom
     * @property {ForecastingAddOn} forecasting
     * @property {TableViewAddOn} tableView
     * @property {object} dataLoader
    ...
    addOns: {
       ...
       *
       * @typedef TooltipAddOn
       * @desc config.addOns.Tooltip
       * @property {null} ohl
       * @property {null} volume
       * @property {boolean} series
       * @property {boolean} studies
       */
      tooltip: {
        ohl: null,
        volume: null,
       ...
       * Inactivity timer
       *
       * @typedef InactivityTimerAddOn
       * @desc config.addOns.inactivityTimer
       ...
       * Animation
       *
       * @typedef AnimationAddOn
       * @desc config.addOns.animation
       * @property {object} animationParameters
       */
      animation: {
       ...
       *
       * @typedef ExtendedHoursAddOn
       * @desc config.addOns.extendedHours
       ...
       *
       * @typedef ContinuousZoomAddOn
       * @desc config.addOns.continuousZoom
       * @property {ContinuousZoomPeriodicity[]} periodicities
       * @property {ContinuousZoomBoundaries} boundaries
       */
      continuousZoom: {
        /**
         * @typedef ContinuousZoomPeriodicity
         * @desc config.addOns.continuousZoom.periodicities[integer]
        ...
        /**
         * @typedef ContinuousZoomBoundaries
         * @desc config.addOns.continuousZoom.boundaries
         * @property {number} maxCandleWidth
         * @property {number} minCandleWidth
         */
        boundaries: {
          maxCandleWidth: 15,
          minCandleWidth: 3,
      ...
      /**
       * @typedef ForecastingAddOn
       * @desc config.addOns.forecasting
       * @property {string} moduleName
       * @property {string} id
       * @property {object} decorator
       * @property {object} renderingParameters
       * @property {object} [quoteFeed]
      ...
      /**
       * @typedef TableViewAddOn
       * @desc config.addOns.tableView
       * @property {string} [coverContainer]
       */
    ...
    // If set will generate a text string to be read on an accessible page when canvas has the focus.
    // chartDescriptor contains useful tokens for generating the text.
    // set to function returning empty string ( () => "" ) to turn off all accessibility.
    // set to undefined to fall back to default text.
    //getCanvasTitle: (chartDescriptor) => chartDescriptor.type + " chart!",
    getCanvasTitle: undefined,
    /**
     * @typedef OnNewSymbolLoad
     * @desc config.onNewSymbolLoad
     * @property {function(series: object): boolean} removeSeries
     * @property {function} [continuousZoom]
     */
    onNewSymbolLoad: {
      ...
      removeSeries(series) {
        return (
          series.parameters.bucket !== "study" && !series.parameters.retoggle
        ); // keeps only studies and series specifically set to remain
      },
    ...
    /**
     * @typedef HotKeyConfig
     * @desc config.hotkeyConfig
     * @property {HotKey} hotkeys
     * @property {string[]} keysToRepeat
     */
    hotkeyConfig: {
       ...
       * @desc config.hotkeyConfig.hotkeys[integer].options
       * @property {number} [percent]
       * @property {number} [bars]
       */
      /**
       * @typedef HotKey
       * @desc config.hotkeyConfig.hotkeys
       * @property {string} label
       * @property {string} action
       * @property {string[]} commands
       * @property {string} [extension]
       * @property {string} [ariaLabel]
       * @property {HotKeyOptions} options
       */
      hotkeys: [
        // precise navigation
        {
          label: "Pan chart up",
          action: "up",
          options: { percent: 0.02 },
          commands: ["ArrowUp", "Up"],
        },
        {
          label: "Pan chart down",
          action: "down",
          options: { percent: 0.02 },
          commands: ["ArrowDown", "Down"],
        },
        {
          label: "Pan chart right",
          action: "right",
          options: { bars: 1 },
          commands: ["ArrowRight", "Right"],
        },
        {
          label: "Pan chart left",
          action: "left",
          options: { bars: 1 },
          commands: ["ArrowLeft", "Left"],
        },
        // fast navigation
        {
        ...
        {
          label: "Pan chart down fast",
          action: "down",
          options: { percent: 0.2 },
          commands: ["Shift+ArrowDown", "Shift+Down"],
        },
        {
          label: "Pan chart right fast",
          action: "right",
          options: { bars: 10 },
          commands: ["Shift+ArrowRight", "Shift+Right"],
        },
        {
          label: "Pan chart left fast",
          action: "left",
          options: { bars: 10 },
          commands: ["Shift+ArrowLeft", "Shift+Left"],
        },
        { label: "Pan to home", action: "home", commands: ["Home"] },
        {
          label: "Pan to start of loaded data",
          action: "end",
          commands: ["End"],
        },
        // page
        {
          label: "Page chart right",
          action: "pageRight",
          commands: ["Alt+ArrowRight", "Alt+Right", "PageUp"],
        },
        {
          label: "Page chart left",
          action: "pageLeft",
          commands: ["Alt+ArrowLeft", "Alt+Left", "PageDown"],
        },
        // zoom
        {
        ...
        {
          label: "Zoom out x-axis",
          action: "zoomOutXAxis",
          commands: ["NumpadSubtract", "-"],
        },
        ...
        // toggle
        {
          ...
          action: "toggleCrosshairs",
          commands: ["Alt+Backslash", "Alt+\\", "Alt+Þ"],
        }, // Alt+Þ for legacy edge support
        {
          label: "Toggle continuous zoom",
          action: "toggleContinuousZoom",
          commands: ["Alt+Digit0", "Alt+0"],
          extension: "continuousZoom",
        },
        // UI navigation
        {
          label: "Tab to next",
          action: "keyboardNavigateNext",
          commands: ["Tab"],
        },
        {
          label: "Tab to previous",
          action: "keyboardNavigatePrevious",
          commands: ["Shift+Tab"],
        },
        ...
        {
          label: "Select at tab",
          action: "keyboardNavigateClick",
          commands: ["Enter", "Space"],
        },
        {
          label: "Toggle Drawings",
          action: "toggleDrawings",
          commands: ["Shift+Alt+KeyH"],
        },
        // AddOns and Plugins
        {
          label: "Table view",
          ...
          commands: ["Alt+KeyK"],
          extension: "tableView",
          ariaLabel: "Opens chart data in table format",
        }, // tableView is modal view, toggling off requires use of Escape
        {
          label: "Range Slider",
          action: "rangeSlider",
          commands: ["Shift+Alt+KeyR"],
          extension: "rangeSlider",
        },
        {
          label: "Extended Hours",
          action: "extendedHours",
          commands: ["Shift+Alt+KeyX"],
          extension: "extendedHours",
        },
        {
          label: "Outliers",
          action: "outliers",
          commands: ["Shift+Alt+KeyO"],
          extension: "outliers",
        },
        {
          label: "Market Depth",
          action: "marketDepth",
          commands: ["Shift+Alt+KeyD"],
          extension: "marketDepth",
        },
        {
          label: "L2 Heat Map",
          action: "l2HeatMap",
          commands: ["Shift+Alt+KeyM"],
          extension: "marketDepth",
        },
        {
          label: "Import Data",
        ...
        {
          label: "Trade From Chart",
          action: "tfc",
          commands: ["Shift+Alt+KeyP"],
          extension: "tfc",
        },
        // global
        {
          label: "Symbol Lookup",
          action: "symbolLookup",
          commands: ["Shift+Alt+KeyL"],
          ariaLabel: "Opens main symbol lookup for chart",
        },
        {
          label: "Delete a highlighted item or the active drawing",
          action: "delete",
          commands: ["Backspace", "Delete", "Del"],
        },
        {
          label: "Close an open menu / dialog box or undo the active drawing",
          action: "escape",
          commands: ["Escape", "Esc"],
        },
        {
          ...
          action: "shortcuts",
          commands: ["Shift+Alt+Slash", "Shift+Alt+?"],
          extension: "shortcuts",
        },
        {
          label: "Command line",
          action: "cli",
          commands: ["Shift+Slash"],
          extension: "cli",
        },
      ],
     ...
     * @desc config.systemMessages[string]
    ...
    systemMessages: {
      ...
      logdeactivated: {
        message:
          "Log scale has been deactivated due to a zero or negative value in your visible dataset.",
        type: "warning",
      },
      studynoteditable: {
      ...
      eldercannotadd: {
        message:
          "Elder Impulse study cannot be activated because a custom chart is already in use.",
        type: "info",
        displayTime: 3,
      },
      gonogocannotadd: {
        message:
          "GoNoGo study cannot be activated because a custom chart is already in use.",
        type: "info",
        displayTime: 3,
      },
      addAVWAP: {
      ...
      drawingsHidden: {
        message:
          "This chart contains drawings that are currently hidden. Press Hide All Drawings to toggle them visible.",
        displayTime: 4,
        type: "error",
      },
      drawingsRevealed: {
    ...
    /**
     * @typedef MarketName
     * @property {string} endpoint - The APIClient endpoint for the market definition API.
     * @property {Function} [extract] - Optional function which is called prior to calling the APIClient endpoint and must return the configuration object that will be passed to APIClient
     * @property {Function} [transform] - Optional function which receives the raw API response and is responsible for parsing it and transforming it into the ChartIQ cannonical form.
     */
    /**
     ...
     * The object's properties - The market definition API specification.
     * The property values - The specification for a market definition API.
     * @example
     * const marketDefinitionAPIs = {
     *   "minimal": {
     *     endpoint: "marketDefinition"
     *   },
     *   "extract": {
     *     endpoint: "marketDefinition",
     *     extract: (symbol) => {
    ...
    /**
     * Include this symbol in the `marketDefinitionMapping` below to set a
     * default mapping. This will cause all symbols to retrieve their
     * market definition from this API, except those explicitly defined.
     */
    marketDefinitionDefaultMapping: "#DEFAULT#",
    /**
     * Object containing mappings of symbols to market definition API specifications.
     * This object maps symbols to corresponding entries in the MarketDefinitionAPIs config.
     * The object's properties - The API-backed symbol.
     * The property values - The key in the MarketDefinitionAPIs object representing the market definition API specification.
     * @example
     * const marketDefinitionMapping = {
     *   "AAPL": "minimal",
     *   "GOOG": "extract",
     *   "SPGI": "transform",
     *   "#DEFAULT#": "minimal"
    ...
    /**
     * @typedef ChartEngineParams
     * @desc config.chartEngineParams
     * @property {ChartEnginePreferences} preferences
     */
    chartEngineParams: {
      /**
       * @typedef ChartEnginePreferences
       * @desc config.chartEngineParams.preferences
       * @property {boolean} labels
       * @property {boolean} currentPriceLine
       * @property {number} whitespace
       * @property {boolean} displayCrosshairsWithDrawingTool
       */
      preferences: {
        labels: false,
    ...
    /**
     * @typedef QuoteFeedsBehavior
     * @desc config.quoteFeeds[integer].behavior
     * @property {number} refreshInterval
     * @property {number} backgroundRefreshInterval
     * @property {number} bufferSize
     */
    /**
     * @typedef QuoteFeeds
     * @desc config.quoteFeeds
     * @property {object} [quoteFeed]
     * @property {QuoteFeedsBehavior} behavior
     */
    ...
    /**
     * @typedef Selector
     * @desc config.selector
     * @property {string} sideNav
     * @property {string} sidePanel
     * @property {string} lookupComponent
     * @property {string} studyLegend
     * @property {string} timeSpanEvent
     * @property {string} markersMenuItem
     * @property {string} themesMenuItem
     * @property {string} tfcTradePanel
     * @property {string} tfcToggle
     */
    selector: {
      sideNav: ".ciq-sidenav",
      ...
      timeSpanEvent:
        ".stx-markers cq-item.span-event, .ciq-markers .switch-item.item[stxtap*=TimeSpanEvent]",
     ...
     * @typedef Themes
     * @desc config.themes
     * @property {object} builtInThemes
     * @property {string} defaultTheme
     * @property {string} nameValueStore
     */
    themes: {
      builtInThemes: {
        "ciq-day": "Day",
    ...
    /**
     * @typedef ExcludedStudies
     * @desc config.menuStudiesConfig.excludedStudies
     * @property {boolean} stochastics
     * @property {boolean} [DoM]
     */
    /**
     * @typedef MenuStudiesConfig
     * @desc config.menuStudiesConfig
     * @property {ExcludedStudies} excludedStudies
     * @property {object} alwaysDisplayDialog
     */
    menuStudiesConfig: {
    ...
    /**
     * @typedef DrawingTools
     * @desc config.drawingTools[integer]
     * @property {string} type
    ...
    /**
     * @typedef MenuRendering
     * @desc config.menuRendering
     * @property {function(params: object): string} item
     * @property {function(params: object): string} checkbox
     * @property {function(params: object): string} dt
     */
    menuRendering: {
      item: ({ label, cmd, cls }) => `
    ...
    getMenu(name, sort) {
      ...
      return this[name].map((options) =>
        this.menuRendering[options.type || "item"](options, this),
      );
    },
    /**
     * @typedef Plugins
     * @desc config.plugins
     * @property {PtvPlugin} [ptv]
     * @property {MarketDepthPlugin} [marketDepth]
     * @property {TfcPlugin} [tfc]
     * @property {CrossSectionPlugin} [crossSection]
     * @property {VisualEarningsPlugin} [visualEarnings]
     * @property {SignalIQPlugin} [signalIQ]
     * @property {StudyBrowserPlugin} [studyBrowser]
     * @property {object} [scriptIQ]
     * @property {TechnicalViewsPlugin} [technicalViews]
     * @property {TechnicalInsightsPlugin} [technicalInsights]
     * @property {object} [timeSpanEventPanel]
     */
    plugins: {
      /**
       * @typedef PtvPlugin
       * @desc config.plugins.ptv
       * @property {string} moduleName
       * @property {string} menuItemSelector
       * @property {boolean} loadSample
       * @property {boolean} showTooltip
       * @property {object} infoPanel
       */
      ptv: {
        moduleName: "TimeSpanEventPanel",
        menuItemSelector:
          ".stx-markers cq-item.span-event, .ciq-markers .item.ciq-active[stxtap*=TimeSpanEvent]",
        loadSample: true,
        showTooltip: true,
       ...
       *
       * @typedef MarketDepthPlugin
       * @desc config.plugins.marketDepth
       * @property {string} height
       * @property {string} [precedingContainer]
       * @property {boolean} volume
       * @property {boolean} mountain
       * @property {boolean} step
       * @property {boolean} [orderbook]
       ...
       *
       * @typedef TfcPlugin
       * @desc config.plugins.tfc
       * @property {string} moduleName
       * @property {string} container
       * @property {string} channel
       * @property {string} toggleMarkup
       * @property {boolean} loadSample
       * @property {boolean} startCompact
       */
      tfc: {
        moduleName: "TFC",
      ...
      /**
       * @typedef CrossSectionPlugin
       * @desc config.plugins.crossSection
       * @property {number} pointFreshnessTimeout
       * @property {boolean} enableTimeSeries
       * @property {string} xAxisType
       * @property {object} timelineDateSelector
       * @property {function(params: object): void} postInstall
      ...
      crossSection: {
        ...
        pathToTimeSeries:
          "plugins/crosssection/sample-time-series-instant-chart.html", // relative path to time series chart
      ...
      /**
       * @typedef SignalIQPlugin
       * @desc config.plugins.signalIQ
       * @property {number} panelHeight
       * @property {boolean} displayCondition
       * @property {SignalIQEmojiPicker} [emojiPicker]
       * @property {string[]} disallowedStudies
       */
      signalIQ: {
        panelHeight: 150,
        displayCondition: false,
        /**
         * @typedef SignalIQEmojiPicker
         * @desc config.plugins.signalIQ.emojiPicker
         * @property {function(params: object): void} open
         * @property {function(): void} clean
          ...
          open({ stx, targetElement, handler }) {
            ...
            if (!this.pickers.has(targetElement)) {
              ...
              this.emojis.forEach((label) => {
                emojiList.push({
                  value: stx.emojify(`:${label.replace(/\|/g, "::")}:`),
                  label,
                });
              });
              this.pickers.set(
                targetElement,
                new resources.emojiPicker({
                  button,
                  targetElement,
      ...
      /**
       * @typedef StudyBrowserPlugin
       * @desc config.plugins.studyBrowser
       * @property {boolean} promoteStudiesMenu
       * @property {function(params: object): void} postInstall
       */
      studyBrowser: {
        ...
        postInstall({ uiContext, extension }) {
          if (this.promoteStudiesMenu) {
            const contextNode =
              ...
              uiContext.topNode;
            const menu = CIQ.UI.BaseComponent.prototype.qsa(
              "cq-menu.ciq-studies[config]",
              contextNode,
              true,
            )[0];
            if (menu && !menu.sbActivated) {
              setTimeout(() => {
                // multichart context is available only in the next event loop
                const topLevelEngine = contextNode.CIQ.UI.context.stx;
                const breakpointChannel =
                  (uiContext.config.channels || {}).breakpoint ||
                  "channel.breakpoint";
                menu.channelSubscribe(
                  breakpointChannel,
                  () => {
                    if (!this.promoteStudiesMenu) return;
                    const value = menu.channelRead(
                      breakpointChannel,
                      topLevelEngine,
                    );
                    menu.setAttribute(
                      "config",
                      value === "break-sm" ? "studies" : "studybrowser",
                    );
                  },
                  topLevelEngine,
                );
      ...
      scriptIQ: {},
      /**
       * @typedef TechnicalViewsPlugin
       * @desc config.plugins.technicalViews
       * @property {string} container
       * @property {string} moduleName
      ...
      technicalViews: {
        container: ".ciq-menu-section .ciq-toggles",
        moduleName: "TCTechnicalViews",
        partner: 1000,
        token: "",
        channel: "channel.technicalviews",
        toggleMarkup: `
      ...
      /**
       * @typedef TechnicalInsightsPlugin
       * @desc config.plugins.technicalInsights
       * @property {string} container
       * @property {string} moduleName
	...
	<cq-toggle feature="cli" class="ciq-cli-button bottom" stxtap="Layout.toggleCLI()" reader="Toggle Command-line Interface" icon="cli" tooltip="Command&nbsp;Line"></cq-toggle>
      ...
      genericPlugin: {
        container: ".ciq-menu-section .ciq-toggles",
        location: "top", // "top" or "right", default is "top"
        toggleMarkup: `
      ...
      ftsChartExplainer: {
        ...
        location: "right",
        toggleMarkup:
          "<cq-toggle class='stx-ftsChartExplainer' member='ftsChartExplainer' reader='FTS Chart Explainer' icon tooltip='FTS Chart Explainer'></cq-toggle>",
        ftsConfig: {
          aiResponseGeneratorConfig: {
            model: "gpt4omini",
            // optional, if you'd like to override the default prompt.
            // prompt: '',
          ...
          apiClientConfig: {
            ...
            // if you need more control, you can also supply you own `FetchClient`
            // fetchClient: myFetchClient,
          },
        },
      },
      lowfrequency: {
        moduleName: "LowFrequencyData",
      },
    },
    ...
    /**
     * @typedef Channels
     * @desc config.channels
     * @property {string} lookup
     * @property {string} crosshair
     * @property {string} headsUp
     * @property {string} sidenav
     * @property {string} tableView
     * @property {string} drawing
     * @property {string} drawingPalettes
     * @property {string} breakpoint
     * @property {string} containerSize
     * @property {string} sidenavSize
     * @property {string} sidepanelSize
     * @property {string} pluginPanelHeight
     * @property {string} tfc
     * @property {string} technicalviews
     * @property {string} technicalinsights
     * @property {string} dataLoader
     * @property {string} dialog
     * @property {string} keyboardNavigation
     ...
     *
     * @typedef ScrollbarStyling
     * @desc config.scrollbarStyling
     * @property {function(component: HTMLElement, options: object): void} refresh
     * @property {function(component: HTMLElement): void} destroy
     */
    scrollbarStyling: {
     ...
     *
     * @typedef SoloActive
     * @desc config.soloActive
     * @property {object} onDraw
     * @property {object} onTFC
     * @property {object} onTechnicalInsights
     * @property {object} onTechnicalViews
     */
    soloActive: {
      onDraw: {
        ...
        notify: {
          message:
            "Click on the draw toggle again to close drawing tools and return to grid view",
        },
      },
      onTFC: {
        shouldSolo(stx) {
        ...
        notify: {
          message:
            "Chart has been maximized to make it easier to set trade prices.",
        },
      },
      onTechnicalInsights: {
        notify: {
          message:
            "Chart has been soloed for plugin use. Disable plugin to restore chart grid.",
        },
      },
      onTechnicalViews: {
        notify: {
     ...
     *
     * @typedef UseQueryString
     * @desc config.useQueryString
     * @property {object} symbolObject
     */
    useQueryString: {
      symbolObject: {
        symbol: "symbol",
    ...
    updateFromQueryString() {
      ...
      const symbolObject = Object.entries(
        this.useQueryString.symbolObject,
      ).reduce((acc, [key, val]) => {
      ...
      if (symbolObject.symbol) {
        ...
        if (this.restore) {
          // do not restore symbol use one set in initialSymbol
    ...
    createChart: function (container) {
      ...
      const config = this;
      if (CIQ.UI)
        return new CIQ.UI.Chart().createChartAndUI({ container, config }).stx;
...
const extendedConfig = (resources) => {
  return {
    ...
    ariaActive: null,
    /**
     * @typedef Attributions
     * @desc config.attributions
     * @property {object} sources
     * @property {object} exchanges
     */
    attributions: {
      sources: {
     ...
     * @typedef Groups
     * @desc config.groups
     * @property {GroupsRange} range
     */
    groups: {
      /**
       * @typedef GroupsRange
       * @desc config.groups.range
     ...
     * @typedef Menus
     * @desc config.menus
     * @property {MenusCrosshair} crosshair
     * @property {MenusDisplay} display
     * @property {MenusInfo} info
     * @property {MenusMarkers} markers
     * @property {MenusPeriod} period
     * @property {MenusPreferences} preferences
     * @property {MenusStudies} studies
     * @property {MenusStudybrowser} studybrowser
     * @property {MenusViews} views
     * @property {MenusCvplinestyle} cvplinestyle
     * @property {MenusFontfamily} fontfamily
     * @property {MenusFontsize} fontsize
     * @property {MenusLinestyle} linestyle
     * @property {MenusToolgrouping} toolgrouping
     * @property {MenusWavecorrective} wavecorrective
     * @property {MenusWaveimpulse} waveimpulse
     * @property {MenusWavetemplate} wavetemplate
     */
    menus: {
      /**
       * navigation menus
       *
       * @typedef MenusCrosshair
       * @desc config.menus.crosshair
       * @property {Content[]} content
       */
      crosshair: {
        content: [
      ...
      /**
       * @typedef MenusDisplay
       * @desc config.menus.display
       * @property {Content[]} content
       */
      display: {
        content: [
          { type: "heading", label: "Chart Types" },
          {
            type: "radio",
            label: "Candle",
            setget: "Layout.ChartType",
            iconCls: "candle",
            value: "candle",
            helpId: "chart_style_candle",
          },
          {
            type: "radio",
            label: "Bar",
          ...
          },
          {
            ...
            value: "colored_bar",
            feature: "advanced",
            helpId: "chart_style_colored_bar",
          },
          {
            type: "radio",
            label: "Line",
            ...
            iconCls: "line",
            value: "line",
            helpId: "chart_style_line",
          },
          {
            type: "radio",
            label: "Colored Line",
            setget: "Layout.ChartType",
            iconCls: "colored-line",
            value: "colored_line",
            feature: "advanced",
            helpId: "chart_style_colored_line",
          },
          {
            type: "radio",
            label: "Vertex Line",
            ...
            iconCls: "vertex-line",
            value: "vertex_line",
            helpId: "chart_style_vertex_line",
          },
          {
            type: "radio",
            label: "Step",
          ...
          },
          {
            ...
            iconCls: "mountain",
            value: "mountain",
            helpId: "chart_style_mountain",
          },
          {
            type: "radio",
            label: "Baseline",
            setget: "Layout.ChartType",
            iconCls: "baseline-delta",
            value: "baseline_delta",
            feature: "advanced",
            helpId: "chart_style_baseline",
          },
          {
            type: "radio",
            label: "Hollow Candle",
            setget: "Layout.ChartType",
            iconCls: "hollow-candle",
            value: "hollow_candle",
            feature: "advanced",
            helpId: "chart_style_hollow_candle",
          },
          {
            type: "radio",
            label: "Volume Candle",
            setget: "Layout.ChartType",
            iconCls: "volume-candle",
            value: "volume_candle",
            feature: "advanced",
            helpId: "chart_style_volume_candle",
          },
          {
            type: "radio",
            ...
            value: "colored_hlc",
            feature: "advanced",
            helpId: "chart_style_colored_hlc_bar",
          },
          {
            type: "radio",
            label: "Data Points",
          ...
          },
          {
            ...
            value: "pandf",
            feature: "advanced",
            helpId: "chart_type_pandf",
          },
        ],
      },
      /**
       * @typedef MenusInfo
       * @desc config.menus.info
       * @property {Content[]} content
       */
      info: {
        content: [
          ...
          {
            type: "item",
            label: "Remove Pinned Tooltips",
            tap: "Markers.removePinnedMarkers",
            value: "pinned_tooltip",
            feature: "pinnedmarkers",
          },
        ],
      },
      /**
       * @typedef MenusMarkers
       * @desc config.menus.markers
       * @property {Content[]} content
       */
      markers: {
        content: [
          ...
          {
            type: "component",
            value: "cq-study-legend",
            attributes: { filter: "signal", "button-remove": "true" },
            feature: "signaliq",
          },
      ...
      period: {
        content: [
          ...
          { type: "separator" },
          {
            ...
            label: "250 MSec",
            tap: "Layout.setPeriodicity",
            value: [1, 250, "millisecond"],
          },
        ],
      },
      /**
       * @typedef MenusPreferences
       * @desc config.menus.preferences
       * @property {Content[]} content
       */
      preferences: {
        content: [
      ...
      /**
       * @typedef MenusStudies
       * @desc config.menus.studies
       * @property {Content[]} content
       */
      studies: {
        content: [
          {
            ...
            attributes: {
              class: "shaded",
              heading: "Active Studies",
              "button-remove": "true",
              "button-clear-all": "Layout.clearStudies()",
            },
          },
          ...
          },
          {
            type: "component",
            value: "cq-studies",
            attributes: { "filter-name": "studylist", favorites: "" },
          },
        ],
      },
      /**
       * removeIf(basic)
       *
       * @typedef MenusStudybrowser
       * @desc config.menus.studybrowser
       * @property {Content[]} content
       * @property {boolean} noscroll
       */
      studybrowser: {
        noscroll: true,
        content: [{ type: "component", value: "cq-study-browser" }],
      },
      /**
       * endRemoveIf(basic)
       *
       * @typedef MenusViews
       * @desc config.menus.views
       * @property {Content[]} content
       */
      views: {
        content: [
       ...
       *
       * @typedef MenusCvplinestyle
       * @desc config.menus.cvplinestyle
       * @property {Content[]} content
       */
      cvplinestyle: {
        content: [
          {
            type: "item",
            label: "Line Style Solid 1",
            tap: "setStyle",
            value: [1, "solid"],
            iconCls: "ciq-line-style-option ciq-solid-1",
          },
          {
            type: "item",
            label: "Line Style Solid 3",
            tap: "setStyle",
            value: [3, "solid"],
            iconCls: "ciq-line-style-option ciq-solid-3",
          },
          {
            type: "item",
            label: "Line Style Solid 5",
            tap: "setStyle",
            value: [5, "solid"],
            iconCls: "ciq-line-style-option ciq-solid-5",
          },
          {
            type: "item",
            label: "Line Style Dotted 1",
            tap: "setStyle",
            value: [1, "dotted"],
            iconCls: "ciq-line-style-option ciq-dotted-1",
          },
          {
            type: "item",
            label: "Line Style Dotted 3",
            tap: "setStyle",
            value: [3, "dotted"],
            iconCls: "ciq-line-style-option ciq-dotted-3",
          },
          {
            type: "item",
            label: "Line Style Dotted 5",
            tap: "setStyle",
            value: [5, "dotted"],
            iconCls: "ciq-line-style-option ciq-dotted-5",
          },
          {
            type: "item",
            label: "Line Style Dashed 1",
            tap: "setStyle",
            value: [1, "dashed"],
            iconCls: "ciq-line-style-option ciq-dashed-1",
          },
          {
            type: "item",
            label: "Line Style Dashed 3",
            tap: "setStyle",
            value: [3, "dashed"],
            iconCls: "ciq-line-style-option ciq-dashed-3",
          },
          {
            type: "item",
            label: "Line Style Dashed 5",
            tap: "setStyle",
            value: [5, "dashed"],
            iconCls: "ciq-line-style-option ciq-dashed-5",
          },
        ],
      },
      /**
       * @typedef MenusFontfamily
       * @desc config.menus.fontfamily
       * @property {Content[]} content
       */
      fontfamily: {
        content: [
      ...
      /**
       * @typedef MenusFontsize
       * @desc config.menus.fontsize
       * @property {Content[]} content
       */
      fontsize: {
        content: [
      ...
      /**
       * @typedef MenusLinestyle
       * @desc config.menus.linestyle
       * @property {Content[]} content
       */
      linestyle: {
        content: [
      ...
      /**
       * @typedef MenusToolgrouping
       * @desc config.menus.toolgrouping
       * @property {Content[]} content
       */
      toolgrouping: {
        content: [], // reserved
      ...
      /**
       * @typedef MenusWavecorrective
       * @desc config.menus.wavecorrective
       * @property {Content[]} content
       */
      wavecorrective: {
        content: [
          {
            ...
            label: "- - -",
            tap: "update",
            value: ["corrective", null],
          },
          {
            type: "item",
            label: "A B C",
            tap: "update",
            value: ["corrective", "A,B,C"],
          },
          {
            type: "item",
            label: "a b c",
      ...
      /**
       * @typedef MenusWaveimpulse
       * @desc config.menus.waveimpulse
       * @property {Content[]} content
       */
      waveimpulse: {
        content: [
          ...
          },
          {
            ...
            label: "1 2 3 4 5",
            tap: "update",
            value: ["impulse", "1,2,3,4,5"],
          },
          {
            type: "item",
            label: "A B C D E",
            tap: "update",
            value: ["impulse", "A,B,C,D,E"],
          },
          {
            type: "item",
            label: "a b c d e",
      ...
      /**
       * @typedef MenusWavetemplate
       * @desc config.menus.wavetemplate
       * @property {Content[]} content
       */
      wavetemplate: {
        content: [
          {
            ...
            tap: "update",
            value: ["template", "Grand Supercycle"],
          },
          {
            type: "item",
            label: "Supercycle",
            tap: "update",
            value: ["template", "Supercycle"],
          },
          {
            type: "item",
            label: "Cycle",
          ...
          },
          {
            ...
            label: "Intermediate",
            tap: "update",
            value: ["template", "Intermediate"],
          },
          {
            type: "item",
            label: "Minor",
            tap: "update",
            value: ["template", "Minor"],
          },
          {
            type: "item",
            label: "Minute",
          ...
          },
          {
            ...
            label: "Minuette",
            tap: "update",
            value: ["template", "Minuette"],
          },
          {
            type: "item",
            label: "Sub-Minuette",
            tap: "update",
            value: ["template", "Sub-Minuette"],
          },
          {
            type: "item",
            label: "Custom",
     ...
     * @typedef Toggles
     * @desc config.toggles
     * @property {TogglesCrosshair} crosshair
     * @property {TogglesInfo} info
     * @property {TogglesSymbolsearch} symbolsearch
     */
    toggles: {
      /**
       * @typedef TogglesCrosshair
       * @desc config.toggles.crosshair
        ...
        callbacks: [
          function (value) {
            ...
            if (!layout.headsUp || typeof layout.headsUp !== "object") {
              if (layout.headsUp === "static")
                layout.headsUp = { static: true };
              else layout.headsUp = {};
            }
            if (!this.listener) {
            ...
            const charts = (this.getCharts && this.getCharts()) || [
              context.stx,
            ];
            const mainChartBreakpoint = charts.slice(-1)[0].channel.breakpoint;
            charts.forEach(({ layout }) => {
              ...
              if (value) {
                if (!headsUp.static) {
                  headsUp.static =
                    this.lastState.static || mainChartBreakpoint === "break-sm";
                }
            ...
            charts.forEach(({ layout }) => {
              ...
              if (value) {
                if (!headsUp.dynamic && !headsUp.floating) {
                  ...
                  headsUp.floating =
                    this.lastState.floating || !headsUp.dynamic;
                }
              } else {
                this.lastState = Object.assign({}, headsUp);
      ...
      /**
       * @typedef TogglesSymbolsearch
       * @desc config.toggles.symbolsearch
       * @property {function[]} callbacks
       */
      symbolsearch: {
        callbacks: [
...
const deprecatedConfig = (resources) => {
  return {
    ...
    menuChartStyle: [
      // if displayStyleIcons is true and a suitable icon class for the iconCls parameter is not available, "generic" class can be applied
      {
        type: "radio",
        label: "Candle",
        cmd: "Layout.ChartType()",
        iconCls: "candle",
        value: "candle",
        helpId: "chart_style_candle",
      },
    ...
    menuChartAggregates: [
      ...
      },
      {
        ...
        label: "Kagi",
        cmd: "Layout.ChartType()",
        options: "Layout.showAggregationEdit('kagi')",
        iconCls: "kagi",
        value: "kagi",
        cls: "advanced-ui",
        helpId: "chart_type_kagi",
      },
      {
        ...
        label: "Line Break",
        cmd: "Layout.ChartType()",
        options: "Layout.showAggregationEdit('linebreak')",
        iconCls: "linebreak",
        value: "linebreak",
        cls: "advanced-ui",
        helpId: "chart_type_linebreak",
      },
      {
        ...
        label: "Renko",
        cmd: "Layout.ChartType()",
        options: "Layout.showAggregationEdit('renko')",
        iconCls: "renko",
        value: "renko",
        cls: "advanced-ui",
        helpId: "chart_type_renko",
      },
      {
        ...
        label: "Range Bars",
        cmd: "Layout.ChartType()",
        options: "Layout.showAggregationEdit('rangebars')",
        iconCls: "rangebars",
        value: "rangebars",
        cls: "advanced-ui",
        helpId: "chart_type_rangebars",
      },
      {
        ...
        label: "Point & Figure",
        cmd: "Layout.ChartType()",
        options: "Layout.showAggregationEdit('pandf')",
        iconCls: "pandf",
        value: "pandf",
        cls: "advanced-ui",
        helpId: "chart_type_pandf",
    ...
    menuPeriodicity: [
      ...
      { type: "separator" },
      {
        type: "item",
        label: "250 MSec",
        cmd: "Layout.setPeriodicity(1,250,'millisecond')",
    ...
    menuAddOns: [
      {
        type: "item",
        label: "Shortcuts / Hotkeys",
        cmd: "Layout.showShortcuts(true)",
        cls: "shortcuts-ui",
      },
      {
        type: "item",
        label: "Import Data",
        cmd: "Channel.write('dataLoader', true)",
        cls: "dataLoader-ui",
      },
    ],
    ...
    menuRendering: {
      ...
      item: ({ label, cmd, cls }) => `
				<cq-item ${cls ? `class="${cls}"` : ""} stxtap="${cmd}">${label}</cq-item>`,
      radio: (
        { label, cmd, options, cls, iconCls, value, helpId },
        { displayStyleIcons },
      ) => `
      ...
      radioOptions: (...args) => {
        // alias for deprecated radioOption
 ...
 * @name getConfig
 * @function
 * @param {Resources} resources See description, these are imported modules that are passed in to be used by the configuration.
...
function getConfig(resources = {}) {
  ...
  if (resources.deprecatedSettings) {
    ...
    if (CIQ.UI) {
      CIQ.UI.usingLegacyComponents = true;
    }
  }
  config.enabledAddOns = new Proxy(config.enabledAddOns, {
    get(target, prop) {
      return config.addOns[prop] && !!config.addOns[prop].enabled;
    },
    set(obj, prop, newValue) {
      if (config.addOns[prop]) {
        config.addOns[prop].enabled = !!newValue;
        return true;
      }
      return false;
    },
