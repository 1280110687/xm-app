 ...
 * Patched by RB (resizeImage checks for iPad/iPhone/iPod/Safari to fix svg pattern fill issue)
 * Patched by RB (DocumentCloner.prototype,cloneNode will not walk through hidden elements: if(B.display==="none")return r;
 */
!(function (A, e) {
    ...
    dn =
      ...
      (fn.prototype.cloneNode = function (A, e) {
        ...
        if (t && XB(A) && (JB(A) || YB(A))) {
          ...
          if (B.display === "none") return r;
          var n = t.getComputedStyle(A, ":before"),
  ...
  var Ls,
    ...
    bs =
      ...
      (Ds.prototype.resizeImage = function (A, e, t) {
        if (
          !/(iPad|iPhone|iPod|Safari)/g.test(navigator.userAgent) &&
          A.width === e &&
          A.height === t
        )
          return A;
