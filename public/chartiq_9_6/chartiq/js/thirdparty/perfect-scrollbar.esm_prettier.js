...
function updateCss(element, i) {
  ...
  if (yRailOffset.top + yRailOffset.height > element.scrollHeight)
    yRailOffset.top = element.scrollHeight - yRailOffset.height;
...
function keyboard(i) {
  ...
  // The following line is added by RB - assign handler to element.keydownEvent.
  i.event.bind(
    i.ownerDocument,
    "keydown",
    (element.keydownEvent = function (e) {
      if (
