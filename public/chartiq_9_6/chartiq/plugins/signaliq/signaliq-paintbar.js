 ...
 * @return {function} Appropriate function to call after the chart is renderered.  The function depends on the chart type.
 * @memberof CIQ.SignalIQ.Paintbar
 * @static
 */
CIQ.SignalIQ.Paintbar.getInjection = function (stx) {
	return function (chart) {
		...
		this.startClip();
		if (isBarType) {
			const pixelWidth = this.mainSeriesRenderer.getPixelWidth();
