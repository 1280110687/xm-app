...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * @module ./quoteFeedSimulator
 * @texport default quoteFeedSimulator
 */
/**
 * @typedef QuoteType
 * @desc quote type
 ...
 * @param {object} params
 * @param {string | number} params.quoteDriverID Unique ID of quotedriver
 * @param {string | number} params.interval Current chart interval
 * @param {string | number} params.period Current chart period
 * @param {boolean} params.extended Whether extended hours data is requested
...
quoteFeedSimulator.fetchInitialData = function (
  ...
  self.postAjax(queryUrl, function (status, response) {
    ...
    if (status === 200) {
      ...
      // const len = newQuotes.length

      // newQuotes[len - 70].up = true
 ...
 *
 * @param {string} response JSON stringified quote response
 * @param {string} [symbol] Requested symbol
 * @return {QuoteType[]} Quote records
 *
 * @memberof quoteFeedSimulator
 */
