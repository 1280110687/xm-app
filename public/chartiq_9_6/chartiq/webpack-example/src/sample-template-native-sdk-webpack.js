...
// set ciq-native-mobile attribute on the context so the necessary chart web components work accordingly
document.querySelector("cq-context").setAttribute("ciq-native-mobile", "");
...
// Keep drawing tool selected between drawings
CIQ.ChartEngine.prototype.keepDrawingToolSelected = true;
...
if (stx) {
	...
	stx.layout.crosshair = false; // crosshairs are controlled by native ui, make sure default state is turned off
	stx.keepDrawingToolSelected = true; // ensure selected drawing tool remains active on the chart
