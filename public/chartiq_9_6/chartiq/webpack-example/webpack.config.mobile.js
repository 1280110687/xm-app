...
import ScriptExtHtmlWebpackPlugin from "script-ext-html-webpack-plugin"; // used to load html partials
...
const resolvedPaths = (subdir = "") =>
	isNpm
		? [
			...
			path.join(chartiqDir, "mobile", subdir),
...
const mobileDir = isNpm ? path.join(chartiqDir, "mobile") : chartiqDir;
